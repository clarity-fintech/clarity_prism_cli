    ...
    repos: [
        {
            ...
            owner: "clarity-fintech",
            repo: "clarity_prism_cli",
            ref: "main",
            role: "company-cli",
        ...
        },
        {
            ...
            ref: "main",
            role: "substrate-api",
            url: "https://github.com/clarity-fintech/developer_kit",
        },
        {
            slug: "wallet-integration",
            owner: "clarity-fintech",
            repo: "wallet_integration",
            ref: "main",
            role: "wallet-sdk",
...
function resolveManifestPath(monorepoPath) {
    const candidates = [
        monorepoPath
...
export function loadManifest(monorepoPath) {
...
export function listRepos(monorepoPath) {
    return loadManifest(monorepoPath).repos;
}
export function getDrift(monorepoPath) {
