...
function seedRegistry(reg: PrimitiveRegistry): void {
  const entries: Omit<Primitive, "version">[] = [
    ...
    { id: "EX-19", category: PrimitiveCategory.Execution, command: "wallet connect", description: "Link wallet to username" },
