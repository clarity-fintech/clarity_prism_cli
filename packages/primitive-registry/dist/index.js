...
function seedRegistry(reg) {
    const entries = [
        ...
        { id: "CM-05", category: PrimitiveCategory.Commons, command: "prism commons send", description: "P2P send by username" },
        { id: "CM-06", category: PrimitiveCategory.Commons, command: "prism commons inbox", description: "Inbound transfer inbox" },
        { id: "CM-07", category: PrimitiveCategory.Commons, command: "prism commons receive", description: "Mark transfer received" },
        ...
        { id: "EX-14", category: PrimitiveCategory.Execution, command: "chain ready", description: "clrty-1 readiness gate" },
        { id: "EX-15", category: PrimitiveCategory.Execution, command: "wallet status", description: "Wallet registry + username" },
        { id: "EX-16", category: PrimitiveCategory.Execution, command: "wallet balance", description: "clrty-1 wallet balance" },
        { id: "EX-17", category: PrimitiveCategory.Execution, command: "wallet registry", description: "Wallet registry snapshot" },
        { id: "EX-18", category: PrimitiveCategory.Execution, command: "wallet nodes", description: "Leverage nodes manifest" },
        { id: "EX-20", category: PrimitiveCategory.Execution, command: "chain dx list", description: "DX primitives catalog" },
        { id: "EX-21", category: PrimitiveCategory.Execution, command: "chain dx parse", description: "Parse DX payload" },
        { id: "EX-22", category: PrimitiveCategory.Execution, command: "chain dx execute", description: "Execute DX primitive" },
        { id: "EX-23", category: PrimitiveCategory.Execution, command: "prism estimate", description: "Execution cost estimate" },
        { id: "EX-24", category: PrimitiveCategory.Execution, command: "prism execute", description: "RAG/GENAI execution" },
        { id: "EX-25", category: PrimitiveCategory.Execution, command: "prism snapshot", description: "Ledger backup" },
        { id: "RG-03", category: PrimitiveCategory.Registry, command: "skill run partner-access", description: "PartnerAccessSkill" },
