...
function relevanceScore(q) {
    ...
    const entropy = typeof q.context?.wallet_entropy === "number" ? q.context.wallet_entropy : 0.5;
    const spread = typeof q.context?.spread_bps === "number" ? q.context.spread_bps : 0;
