...
export const FUNNELS: Funnel[] = [
  {
    ...
    label: "Home",
    icon: "",
    description: "PRISM terminal — terminal use only · port-backed funnels",
    commands: [{ key: "help", label: "Full terminal usage", hint: "Press Enter for complete guide" }],
  },
  {
    id: "prism",
  ...
  },
  {
    ...
    label: "Commons",
    icon: "",
    description: "TERMINAL USE ONLY — 1GB file cache · library · tax-logged P2P transfers",
    requiresAccess: "entitled",
    commands: [
      { key: "__commons_panel__", label: "File cache & library", hint: "TERMINAL USE ONLY — panel above" },
  ...
  },
  {
    ...
    icon: "",
    description: "Run PRISM commands in-terminal — live port when connected",
    commands: [
      { key: "help", label: "Full terminal usage", hint: "Complete PRISM terminal guide" },
      { key: "prism query", label: "PRISM query — arbitrage scan", hint: "Terminal · port-backed" },
