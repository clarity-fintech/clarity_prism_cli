...
import { validateUsername, type EntitlementSnapshot } from "../lib/access-gate";
...
export default function AccountSection({
  ...
  return (
    <>
      <section id="gate-account" className="gate-scroll-section funnel-panel account-section">
      ...
      <section id="gate-unlock" className="gate-scroll-section funnel-panel account-unlock-section">
        <div className="funnel-panel-title">Public unlock paths (investors & partners)</div>
      ...
      <section id="gate-contact" className="gate-scroll-section gate-contact-section">
        <div className="account-gate-contact">
          Need access? Contact{" "}
          <a href={`mailto:${GATE_CONTACT_EMAIL}`}>{GATE_CONTACT_EMAIL}</a>
        </div>
      </section>
    </>
  );
