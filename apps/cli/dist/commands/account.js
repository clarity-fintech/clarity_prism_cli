import { createProfile, loadProfile, loadSession, saveSession, maskEmail, validateUsername, usernameNamespace, } from "@clrt/account-profile";
...
export function registerAccount(program) {
    ...
    account
        ...
        const session = {
            method: (opts.device ? "device-code" : "pkce"),
